...
<body>
	...
	<ul>
		...
		<li><a href="<%=beerContDir%>/BeerController.jsp?actionType=U">맥주정보조회(U, MVC패턴적용)</a>
		<li><a href="<%=beerContDir%>/BeerController.jsp?actionType=D">맥주정보조회(D, MVC패턴적용)</a>
	</ul>
