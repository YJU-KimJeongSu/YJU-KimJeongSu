...
<%@ page import="kjs67_mvc_beer.model.beer.*" %>
...
<head>
<meta charset="UTF-8">
<title>마이쇼핑몰(KJS67) - 맥주자료수정(U)</title>
</head>
<body>
	<h1>마이쇼핑몰(KJS67) - 맥주자료수정(U)</h1>
	<hr>
	<%
	BeerDTO beer;
	...
	<table border="1">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="<%=beerContDir%>/BeerController.jsp?actionType=U2&b_id=<%=beer.getB_id()%>">UPDATE</a></td>
			</tr>
			<%
			}
			%>
