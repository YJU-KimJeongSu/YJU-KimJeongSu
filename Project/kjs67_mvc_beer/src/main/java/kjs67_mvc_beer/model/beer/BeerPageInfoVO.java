package kjs67_mvc_beer.model.beer;
...
public class BeerPageInfoVO {
	...
	public BeerPageInfoVO(int limitCnt, int recordCnt, int pageCnt, 
			int startRecord, int currentPageNo, int startPageNo, int endPageNo) {
		super();
	...
	public void adjPageCnt() {
		...
		if (recordCnt % limitCnt != 0) pageCnt++;
	}
	...
	public void adjEndPageNo() {
		...
		if (endPageNo > pageCnt) endPageNo = pageCnt;
	}
